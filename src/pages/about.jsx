    ...
    <section className="">
      ...
      <div className="px-4 flex flex-col gap-6 mt-10 mb-4">
        ...
        <p>
          ...
          rental. Our vans are cerified before each trip to ensure your travel
          plans can go off without a hitch. <br />
          (hitch costs extra😉) <br />
          <br />
          Our team is full of vanlife enthusiasts who know firstthand the magic
        ...
        <div className="bg-[#ffcc8d] rounded-md p-6 flex flex-col gap-4">
          ...
          <Link
            to="/vans"
            className="bg-black text-white text-sm font-bold p-2 rounded-md w-fit"
          >
            Explore our van
          </Link>
        </div>
