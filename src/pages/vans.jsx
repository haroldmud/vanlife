...
import { useLoaderData,useLocation, Link, useSearchParams, Await, defer } from "react-router-dom";
...
export default function Vans() {
  ...
  const renderVansElement= vans => {
    ...
    ? vans.filter((char) => char.type.toLowerCase() === searchFilter)
    : vans; 
